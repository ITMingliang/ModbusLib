...
namespace Modbus.Communication.Helper
{
    public class ManageCOM
    {
        ...
        /// 自动获取串口的端口号
        /// </summary>
        /// <returns>COM号</returns>
        public List<string> AutoGetCOM()
        {
            List<string> coms = new List<string>();
            List<string> selectComs = new List<string>();
            ...
            foreach (string portName in portNames)
            {
                ...
                {
                    string s = portName.Substring(portName.IndexOf('(') + 1, portName.IndexOf(')') - portName.IndexOf('(') - 1);
                    selectComs.Add(s);
                }
            }
            return selectComs;
